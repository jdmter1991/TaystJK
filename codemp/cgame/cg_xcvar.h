...
XCVAR_DEF( cg_drawTeamOverlayScale,	"1.0",	NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_drawTeamOverlayMaxHP,	"150",	NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_drawTeamOverlayForce,	"1",	NULL,					CVAR_ARCHIVE )
...
XCVAR_DEF( cg_killfeedReverse,                  "0",                	NULL,                       CVAR_ARCHIVE )
